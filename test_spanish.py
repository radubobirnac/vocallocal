...
try:
    # Test with code only
    code_only_result = test_translation_with_code(sample_text, "es")
    
    # Test with name and code
    name_and_code_result = test_translation_with_name_and_code(sample_text, "es", "Spanish")
    
    # Compare results
    print(f"\nComparison for Spanish:")
    ...
    print(f"Error testing Spanish: {str(e)}")
